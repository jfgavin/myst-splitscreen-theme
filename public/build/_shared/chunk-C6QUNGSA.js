import {
  ...
  strlen,
  substr
} from "/myst_assets_folder/_shared/chunk-CNS63BWT.js";
import {
  ...
  "../../node_modules/react-dom/cjs/react-dom-server-legacy.browser.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var scriptReplacer = function(match2, prefix3, s2, suffix) {
...
// app/components/SidebarMediaHandler.tsx
var import_react6 = __toESM(require_react());

// app/components/LineConnector.tsx
var import_react = __toESM(require_react());
var import_jsx_dev_runtime = __toESM(require_jsx_dev_runtime());
var LineConnector = ({ containerPairs, showLines }) => {
  const canvasRef = (0, import_react.useRef)(null);
  const animationFrameRef = (0, import_react.useRef)(null);
  const hoverStartTimes = (0, import_react.useRef)(/* @__PURE__ */ new Map());
  const [hoveredElements, setHoveredElements] = (0, import_react.useState)(/* @__PURE__ */ new Set());
  const updateHoverState = (0, import_react.useCallback)(() => {
    const figures = document.querySelectorAll("figure");
    const newHoveredElements = /* @__PURE__ */ new Set();
    figures.forEach((figure) => {
      if (figure.matches(":hover")) {
        newHoveredElements.add(figure);
      }
    });
    setHoveredElements(newHoveredElements);
  }, []);
  const drawLines = (0, import_react.useCallback)((timestamp) => {
    ...
    containerPairs.forEach((copy2, original) => {
      if (original && copy2 && (hoveredElements.has(copy2) || showLines && copy2.offsetWidth > 0)) {
        if (!hoverStartTimes.current.has(copy2)) {
          hoverStartTimes.current.set(copy2, timestamp);
        }
        const originalRect = original.getBoundingClientRect();
        const copyRect = copy2.getBoundingClientRect();
        ...
        const hoverStartTime = hoverStartTimes.current.get(copy2) || 0;
        ...
        hoverStartTimes.current.delete(copy2);
      }
    });
  }, [containerPairs, hoveredElements]);
  const animateLines = (0, import_react.useCallback)((timestamp) => {
    drawLines(timestamp);
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
    ...
    false,
    {
      fileName: "app/components/LineConnector.tsx",
      lineNumber: 110,
      columnNumber: 5
    },
    this
...
var LineConnector_default = LineConnector;
...
var ImageModal = ({ src, alt, onClose }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Overlay, { onClick: onClose, children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(ModalContent, { onClick: (e) => e.stopPropagation(), children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(ModalImage, { src, alt }, void 0, false, {
      fileName: "app/components/ImageModal.tsx",
      lineNumber: 27,
      columnNumber: 9
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("button", { onClick: onClose, className: "w-12 h-12 bg-blue-500 hover:bg-blue-600 active:bg-blue-700 text-white rounded-full flex items-center justify-center absolute top-1 right-1", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(X2, { size: 24 }, void 0, false, {
      fileName: "app/components/ImageModal.tsx",
      lineNumber: 29,
      columnNumber: 11
    }, this) }, void 0, false, {
...
var SidebarMediaHandler = ({
  containers,
  showSidebar,
  showLines
}) => {
  const [containerPairs, setContainerPairs] = (0, import_react6.useState)(/* @__PURE__ */ new Map());
  const [modalImage, setModalImage] = (0, import_react6.useState)(null);
  const openModal = (0, import_react6.useCallback)((src, alt) => {
    setModalImage({ src, alt });
  }, []);
  const closeModal = (0, import_react6.useCallback)(() => {
    setModalImage(null);
  }, []);
  const styleCopy = (copy2) => {
    copy2.style.transition = "transform 0.3s ease-out";
    copy2.style.position = "relative";
    copy2.style.height = "fit-content";
    copy2.style.maxWidth = "max-content";
    copy2.style.overflow = "hidden";
  };
  const sidebarRef = (0, import_react6.useRef)(null);
  const mainRef = (0, import_react6.useRef)(null);
  ...
  const updateCopyStyles = () => {
    var _a;
    const viewportHeight = ((_a = mainRef.current) == null ? void 0 : _a.clientHeight) || window.innerHeight;
    ...
    containerPairs.forEach((copy2, original) => {
      ...
      const maxDistance = oldMaxDistance + 200;
      let scale = Math.sin(0.5 * Math.PI * Math.max(0, 1 - distanceFromCenter / maxDistance));
      if (scale > 0) {
        copy2.style.transform = `scale(${scale})`;
        copy2.style.width = `${scale * 100}%`;
        copy2.style.display = "block";
        copy2.style.padding = "3px";
        copy2.style.border = "1px solid";
        copy2.style.margin = "1px";
        const figcaptions = copy2.querySelectorAll("figcaption");
        figcaptions.forEach((figcaption) => {
          figcaption.style.maxHeight = `${scale * 2}em`;
        });
        copy2.onclick = () => {
          const img = copy2.querySelector("img");
          if (img) {
  ...
  (0, import_react6.useEffect)(updateContainerPairs, [containers]);
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { className: "flex flex-col items-center", ref: sidebarRef, children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(MyST, { ast: containers }, void 0, false, {
      fileName: "app/components/SidebarMediaHandler.tsx",
      lineNumber: 182,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(LineConnector_default, { containerPairs, showLines }, void 0, false, {
      fileName: "app/components/SidebarMediaHandler.tsx",
      lineNumber: 183,
      columnNumber: 7
    }, this),
    modalImage && /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(
      ImageModal_default,
      {
        src: modalImage.src,
        alt: modalImage.alt,
...
var SidebarMediaHandler_default = SidebarMediaHandler;

// app/components/SidebarVideoHandler.tsx
var import_react8 = __toESM(require_react());

// app/components/VideoHierarchy.tsx
var import_react7 = __toESM(require_react());

// app/components/VidButtons.tsx
var import_jsx_dev_runtime4 = __toESM(require_jsx_dev_runtime());
var VidButtons = ({ firstIndex, divElements, setVideoIndex }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "flex justify-end h-full ml-2 mr-2 z-10", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "flex flex-col justify-between items-center h-full w-12", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "flex-1" }, void 0, false, {
      fileName: "app/components/VidButtons.tsx",
      lineNumber: 68,
      columnNumber: 9
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "flex-1" }, void 0, false, {
    ...
    firstIndex != null ? (divElements[firstIndex - 1] || allowCyclicButtons) && /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("button", { onClick: handleUpClick, className: "w-12 h-12 bg-blue-500 hover:bg-blue-600 active:bg-blue-700 text-white rounded-full flex items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(ArrowUpToLine, { size: 24 }, void 0, false, {
      fileName: "app/components/VidButtons.tsx",
      lineNumber: 73,
      columnNumber: 13
    }, this) }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "flex items-center justify-center text-xl text-white font-semibold bg-blue-500 rounded-full p-1", children: firstIndex != null ? firstIndex + 1 + "/" + divElements.length : null }, void 0, false, {
      fileName: "app/components/VidButtons.tsx",
      lineNumber: 77,
      columnNumber: 9
    }, this),
    firstIndex != null ? (divElements[firstIndex + 1] || allowCyclicButtons) && /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("button", { onClick: handleDownClick, className: "w-12 h-12 bg-blue-500 hover:bg-blue-600 active:bg-blue-700 text-white rounded-full flex items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(ArrowDownToLine, { size: 24 }, void 0, false, {
      fileName: "app/components/VidButtons.tsx",
      lineNumber: 83,
      columnNumber: 13
    }, this) }, void 0, false, {
...
var VidButtons_default = VidButtons;

// app/components/VideoHierarchy.tsx
var import_jsx_dev_runtime5 = __toESM(require_jsx_dev_runtime());
var VideoHierarchy = ({ containerPairs }) => {
  const [videoIndex, setVideoIndex] = (0, import_react7.useState)(null);
  const [videoElements, setVideoElements] = (0, import_react7.useState)([]);
  ...
  const showCopy = (copy2) => {
    copy2.style.display = "block";
    copy2.style.width = "100%";
    copy2.style.height = `${copy2.offsetWidth * (9 / 16)}px`;
    if (copy2.offsetWidth >= 10) {
      playVideo(copy2);
    } else {
      pauseVideo(copy2);
    }
  };
  const hideCopy = (copy2) => {
    pauseVideo(copy2);
    copy2.style.display = "none";
    copy2.style.width = "0";
  ...
  (0, import_react7.useEffect)(() => {
    const videoCopies = Array.from(containerPairs.values());
    const videoElements2 = Array.from(containerPairs.keys());
    setVideoElements(videoElements2);
      ...
      (entries) => {
        entries.forEach((entry) => {
          ...
          if (containerPairs.has(original)) {
            const copy2 = containerPairs.get(original);
            if (copy2) {
              const index = videoCopies.indexOf(copy2);
              const isScrolledToBottom = scrollableParent.scrollTop + scrollableParent.clientHeight >= scrollableParent.scrollHeight;
              if (index >= 0) {
                if (isScrolledToBottom) {
                  if (index === videoIndex) {
  ...
  (0, import_react7.useEffect)(() => {
    ...
    containerPairs.forEach((copy2) => {
      resizeObserver.observe(copy2);
    });
    return () => {
      resizeObserver.disconnect();
    };
  }, [containerPairs]);
  return videoIndex != null ? /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(VidButtons_default, { firstIndex: videoIndex, divElements: videoElements, setVideoIndex }, void 0, false, {
    fileName: "app/components/VideoHierarchy.tsx",
    lineNumber: 136,
    columnNumber: 7
  }, this) : null;
};
var VideoHierarchy_default = VideoHierarchy;

// app/components/SidebarVideoHandler.tsx
var import_jsx_dev_runtime6 = __toESM(require_jsx_dev_runtime());
var SidebarVideoHandler = ({
  containers,
  showSidebar,
  showLines
}) => {
  const [containerPairs, setContainerPairs] = (0, import_react8.useState)(/* @__PURE__ */ new Map());
  const [originalIdCount, setOriginalIdCount] = (0, import_react8.useState)(0);
  const [copyIdCount, setCopyIdCount] = (0, import_react8.useState)(0);
  const [videoCopyList, setVideoCopyList] = (0, import_react8.useState)([]);
  const sidebarRef = (0, import_react8.useRef)(null);
  const setStyling = () => {
    containerPairs.forEach((copy2, original) => {
      copy2.style.position = "relative";
      copy2.style.maxWidth = "400px";
      copy2.style.width = "100%";
      copy2.style.padding = "3px";
      copy2.style.border = "1px solid";
  ...
  (0, import_react8.useEffect)(() => {
    if (containerPairs.size > 0)
      return;
    const newContainerPairs = /* @__PURE__ */ new Map();
    ...
    iframes.forEach((iframe) => {
      ...
      const topTopDiv = (_a = iframe.parentElement) == null ? void 0 : _a.parentElement;
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)("div", { id: "sidebarVideoBox", className: " w-fit mt-auto px-4 py-2 flex flex-column overflow-hidden items-center", style: { paddingRight: "4rem" }, ref: sidebarRef, children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(MyST, { ast: containers }, void 0, false, {
      fileName: "app/components/SidebarVideoHandler.tsx",
      lineNumber: 122,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(VideoHierarchy_default, { containerPairs }, void 0, false, {
      fileName: "app/components/SidebarVideoHandler.tsx",
      lineNumber: 123,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(LineConnector_default, { containerPairs, showLines }, void 0, false, {
      fileName: "app/components/SidebarVideoHandler.tsx",
      lineNumber: 124,
      columnNumber: 7
    }, this)
...
var SidebarVideoHandler_default = SidebarVideoHandler;

// app/components/SidebarMedia.tsx
var import_jsx_dev_runtime7 = __toESM(require_jsx_dev_runtime());
var SidebarMedia = ({ showSidebar, sidebarMedia, sidebarVideos, showLines }) => {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("section", { className: "h-full flex flex-col border-l px-1", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("div", { className: "pt-5" }, void 0, false, {
      fileName: "app/components/SidebarMedia.tsx",
      lineNumber: 18,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("div", { className: "pt-5" }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("div", { className: "flex-grow overflow-auto px-4", children: /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("div", { className: "sidebarMediaBox cursor-pointer hover:no-underline", children: /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(SidebarMediaHandler_default, { showSidebar, containers: sidebarMedia, showLines }, void 0, false, {
      fileName: "app/components/SidebarMedia.tsx",
      lineNumber: 24,
      columnNumber: 11
    }, this) }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("div", { className: "flex-shrink-0", style: { margin: "0 0 auto 0" }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(SidebarVideoHandler_default, { showSidebar, containers: sidebarVideos, showLines }, void 0, false, {
      fileName: "app/components/SidebarMedia.tsx",
      lineNumber: 29,
      columnNumber: 9
    }, this) }, void 0, false, {
...
var SidebarMedia_default = SidebarMedia;
...
var calc = ssr ? "calc" : ["", "-webkit-", "-moz-", "-o-"].filter(function(prefix2) {
  var el = document2.createElement("div");
  el.style.cssText = "width:" + prefix2 + "calc(9px)";
  return !!el.style.length;
}).shift() + "calc";
var isString = function(v2) {
  return typeof v2 === "string" || v2 instanceof String;
};
...
var Split = function(idsOption, options) {
  ...
  function adjust(offset) {
    var a2 = elements[this.a];
    var b = elements[this.b];
    var percentage = a2.size + b.size;
    a2.size = offset / this.size * percentage;
    b.size = percentage - offset / this.size * percentage;
    setElementSize(a2.element, a2.size, this[aGutterSize], a2.i);
  ...
  function drag(e) {
    ...
    if (offset <= a2.minSize + a2.snapOffset + this[aGutterSize]) {
      offset = a2.minSize + this[aGutterSize];
    } else if (offset >= this.size - (b.minSize + b.snapOffset + this[bGutterSize])) {
      offset = this.size - (b.minSize + this[bGutterSize]);
    }
    if (offset >= a2.maxSize - a2.snapOffset + this[aGutterSize]) {
      offset = a2.maxSize + this[aGutterSize];
  ...
  function calculateSizes() {
    var a2 = elements[this.a].element;
    var b = elements[this.b].element;
    var aBounds = a2[getBoundingClientRect]();
  ...
  function trimToMin(sizesToTrim) {
    ...
    if (minSizes.reduce(function(a2, b) {
      return a2 + b;
    }, 0) > parentSize) {
      return sizesToTrim;
    }
  ...
  function stopDragging() {
    var self = this;
    var a2 = elements[self.a].element;
    ...
    self.stop = null;
    self.move = null;
    a2[removeEventListener]("selectstart", NOOP);
    a2[removeEventListener]("dragstart", NOOP);
    b[removeEventListener]("selectstart", NOOP);
    b[removeEventListener]("dragstart", NOOP);
    a2.style.userSelect = "";
    a2.style.webkitUserSelect = "";
    a2.style.MozUserSelect = "";
    a2.style.pointerEvents = "";
    b.style.userSelect = "";
  ...
  function startDragging(e) {
    ...
    a2[addEventListener]("selectstart", NOOP);
    a2[addEventListener]("dragstart", NOOP);
  ...
  var pairs = [];
  elements = ids.map(function(id, i2) {
    var element = {
      element: elementOrSelector(id),
      size: sizes[i2],
      minSize: minSizes[i2],
      maxSize: maxSizes[i2],
      snapOffset: snapOffsets[i2],
      i: i2
    };
    var pair;
    if (i2 > 0) {
  ...
  function setSizes(newSizes) {
    ...
    trimmed.forEach(function(newSize, i2) {
      if (i2 > 0) {
        var pair = pairs[i2 - 1];
        var a2 = elements[pair.a];
        var b = elements[pair.b];
        a2.size = trimmed[i2 - 1];
        b.size = newSize;
        setElementSize(a2.element, a2.size, pair[aGutterSize], a2.i);
...
var SplitWrapper = /* @__PURE__ */ function(superclass) {
  ...
  SplitWrapper2.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
    ...
    if (Array.isArray(minSize) && Array.isArray(prevMinSize)) {
      ...
      minSize.forEach(function(minSizeI, i2) {
        minSizeChanged = minSizeChanged || minSizeI !== prevMinSize[i2];
      });
    ...
    if (needsRecreate) {
      ...
      sizes.forEach(function(sizeI, i2) {
        sizeChanged = sizeChanged || sizeI !== prevSizes[i2];
      });
      if (sizeChanged) {
...
// app/components/GutterStyle.tsx
var import_react10 = __toESM(require_react());
var import_server = __toESM(require_server_browser());
var import_jsx_dev_runtime8 = __toESM(require_jsx_dev_runtime());
var GutterStyle = () => {
  const guttersRef = (0, import_react10.useRef)([]);
  (0, import_react10.useEffect)(() => {
    ...
    gutters.forEach((gutter) => {
      ...
      gutterContents.innerHTML = import_server.default.renderToStaticMarkup(/* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)(EllipsisVertical, { size: "100%" }, void 0, false, {
        fileName: "app/components/GutterStyle.tsx",
        lineNumber: 18,
        columnNumber: 70
      }, this));
...
var GutterStyle_default = GutterStyle;

// app/components/ControlBar.tsx
var import_react11 = __toESM(require_react());
var import_jsx_dev_runtime9 = __toESM(require_jsx_dev_runtime());
var ControlBar = ({ hideTOC, tocRef, projectSlug, footer, setHideTOC, showSidebar, setShowSidebar, showLines, setShowLines }) => {
  const [openControls, setOpenControls] = (0, import_react11.useState)(false);
  const [isFullyOpen, setIsFullyOpen] = (0, import_react11.useState)(true);
  ...
  const tocElemRef = (0, import_react11.useRef)(null);
  const handleOpen = () => {
    if (openControls) {
      setTimeout(() => {
  ...
  (0, import_react11.useEffect)(() => {
    ...
    if (tocElemRef.current != null) {
      ...
      const hiddenChild = div.firstChild;
      const hiddenChildChild = hiddenChild.firstChild;
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("div", { className: "h-screen z-10 flex flex-row justify-center items-center relative", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("div", { className: "pt-5" }, void 0, false, {
            fileName: "app/components/ControlBar.tsx",
            lineNumber: 95,
            columnNumber: 9
          }, this),
          /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("div", { className: "pt-5" }, void 0, false, {
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("button", { onClick: handleShowSidebar, className: buttonStyle, children: "Toggle Splitscreen" }, void 0, false, {
                  fileName: "app/components/ControlBar.tsx",
                  lineNumber: 101,
                  columnNumber: 11
                }, this),
                /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("button", { onClick: handleShowLines, className: buttonStyle, children: "Show Lines" }, void 0, false, {
                  fileName: "app/components/ControlBar.tsx",
                  lineNumber: 104,
                  columnNumber: 11
                }, this)
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("div", { className: "overflow-y-auto overflow-x-hidden", ref: tocElemRef, children: /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)(TableOfContents, { tocRef, projectSlug, footer }, void 0, false, {
            fileName: "app/components/ControlBar.tsx",
            lineNumber: 110,
            columnNumber: 11
          }, this) }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("div", { className: "openerProps", children: /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("button", { onClick: handleOpen, className: openerStyle, style: { borderRadius: "0% 50% 50% 0%" }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)(
      ArrowRightFromLine,
      {
...
function AddPlaybackAttributes({ node }) {
  let source = node.src;
  if (source) {
    if (source.indexOf("?") == -1) {
      source += "?";
...
var ArticlePage = import_react12.default.memo(function({
  article,
  ...
  const pageDesign = (_b = (_a = article.frontmatter) == null ? void 0 : _a.options) != null ? _b : {};
  ...
  const keywords = (_f = (_e2 = article.frontmatter) == null ? void 0 : _e2.keywords) != null ? _f : [];
  const parts = extractKnownParts(tree);
  const [showSidebar, setShowSidebar] = (0, import_react12.useState)(true);
  const [showLines, setShowLines] = (0, import_react12.useState)(false);
  const [sizes, setSizes] = (0, import_react12.useState)(showSidebar ? [50, 50] : [100, 0]);
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(GridSystemProvider, { gridSystem: gridChoice, children: /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)("div", { id: "controlBar", className: "flex flex-row h-screen", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(
      ...
      false,
      {
        fileName: "app/components/ArticlePage.tsx",
        lineNumber: 149,
        columnNumber: 9
      },
      this
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(
      react_split_es_default,
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)("main", { className: "h-full px-4 overflow-auto", children: /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(
            ReferencesProvider,
            {
              references: { ...article.references, article: article.mdast },
              frontmatter: article.frontmatter,
              children: /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(BusyScopeProvider, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(ExecuteScopeProvider, { enable: (_g = compute == null ? void 0 : compute.enabled) != null ? _g : false, contents: article, children: [
                !hide_title_block && /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(
                  FrontmatterBlock,
                  {
                    kind: article.kind,
                ...
                (compute == null ? void 0 : compute.enabled) && compute.features.notebookCompute && article.kind === SourceFileKind.Notebook && /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(NotebookToolbar, { showLaunch: true }, void 0, false, {
                  fileName: "app/components/ArticlePage.tsx",
                  lineNumber: 184,
                  columnNumber: 65
                }, this),
                (compute == null ? void 0 : compute.enabled) && article.kind === SourceFileKind.Article && /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(ErrorTray, { pageSlug: article.slug }, void 0, false, {
                  fileName: "app/components/ArticlePage.tsx",
                  lineNumber: 186,
                  columnNumber: 21
                }, this),
                /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)("div", { id: "skip-to-article" }, void 0, false, {
                  fileName: "app/components/ArticlePage.tsx",
                  lineNumber: 188,
                  columnNumber: 19
                }, this),
                /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(FrontmatterParts, { parts, keywords, hideKeywords }, void 0, false, {
                  fileName: "app/components/ArticlePage.tsx",
                  lineNumber: 189,
                  columnNumber: 19
                }, this),
                /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(ContentBlocks, { pageKind: article.kind, mdast: tree }, void 0, false, {
                  fileName: "app/components/ArticlePage.tsx",
                  lineNumber: 190,
                  columnNumber: 19
                }, this),
                /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(BackmatterParts, { parts }, void 0, false, {
                  fileName: "app/components/ArticlePage.tsx",
                  lineNumber: 191,
                  columnNumber: 19
                }, this),
                /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(Footnotes, {}, void 0, false, {
                  fileName: "app/components/ArticlePage.tsx",
                  lineNumber: 192,
                  columnNumber: 19
                }, this),
                /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(Bibliography, {}, void 0, false, {
                  fileName: "app/components/ArticlePage.tsx",
                  lineNumber: 193,
                  columnNumber: 19
                }, this),
                /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(ConnectionStatusTray, {}, void 0, false, {
                  fileName: "app/components/ArticlePage.tsx",
                  lineNumber: 194,
                  columnNumber: 19
                }, this),
                !hide_footer_links && !hide_all_footer_links && /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(FooterLinksBlock, { links: article.footer }, void 0, false, {
                  fileName: "app/components/ArticlePage.tsx",
                  lineNumber: 196,
                  columnNumber: 21
                }, this)
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)("div", { style: { display: showSidebar ? "block" : "none", width: showSidebar ? "auto" : "0" }, children: /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(SidebarMedia_default, { showSidebar, sidebarMedia, sidebarVideos, showLines }, void 0, false, {
            fileName: "app/components/ArticlePage.tsx",
            lineNumber: 203,
            columnNumber: 13
          }, this) }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(GutterStyle_default, {}, void 0, false, {
      fileName: "app/components/ArticlePage.tsx",
      lineNumber: 206,
      columnNumber: 9
    }, this)
...
var meta = ({ data, matches: matches2, location }) => {
  ...
  const siteTitle = (_b = (_a = config == null ? void 0 : config.title) != null ? _a : project == null ? void 0 : project.title) != null ? _b : "";
  return getMetaTagsForArticle({
    origin: "",
    url: location.pathname,
    title: (page == null ? void 0 : page.title) ? `${page.title}${siteTitle ? ` - ${siteTitle}` : ""}` : siteTitle,
    description: (_e2 = (_d = (_c = page == null ? void 0 : page.description) != null ? _c : project == null ? void 0 : project.description) != null ? _d : config == null ? void 0 : config.description) != null ? _e2 : void 0,
    image: (_g = (_f = (page == null ? void 0 : page.thumbnailOptimized) || (page == null ? void 0 : page.thumbnail)) != null ? _f : (project == null ? void 0 : project.thumbnailOptimized) || (project == null ? void 0 : project.thumbnail)) != null ? _g : void 0,
    twitter: (_h = config == null ? void 0 : config.options) == null ? void 0 : _h.twitter,
    keywords: (_k = (_j = (_i = page == null ? void 0 : page.keywords) != null ? _i : project == null ? void 0 : project.keywords) != null ? _j : config == null ? void 0 : config.keywords) != null ? _k : []
  });
};
var links = () => [KatexCSS];
function ArticlePageAndNavigation({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)(UiStateProvider, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)(TopNav, {}, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)(
      Navigation,
      {
        tocRef: toc,
        hide_toc,
        footer: /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)(MadeWithMyst, {}, void 0, false, {
          fileName: "app/routes/$.tsx",
          lineNumber: 95,
          columnNumber: 17
        }, this),
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)(TabStateProvider, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)("article", { ref: container, className: "article content h-screen fixed", style: { marginTop: top }, children }, void 0, false, {
      fileName: "app/routes/$.tsx",
      lineNumber: 99,
      columnNumber: 9
    }, this) }, void 0, false, {
...
function Page() {
  ...
  const [hideTOC, setHideTOC] = (0, import_react13.useState)(true);
  const inset = 20;
  const top = useThemeTop();
  const { container, toc } = useTocHeight(top, inset);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)(ArticlePageAndNavigation, { hide_toc: hideTOC, projectSlug: data.page.project, children: /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)(ProjectProvider, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)(
    ComputeOptionsProvider,
    {
      features: { notebookCompute: true, figureCompute: true, launchBinder: false },
      children: /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)(ThebeLoaderAndServer, { baseurl, children: /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)(
        ArticlePage,
        {
          article: data.page,
...
function CatchBoundary() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)(ArticlePageAndNavigation, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)("main", { className: "article", children: /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)(ArticlePageCatchBoundary, {}, void 0, false, {
    fileName: "app/routes/$.tsx",
    lineNumber: 151,
    columnNumber: 9
  }, this) }, void 0, false, {
