...
} from "/myst_assets_folder/_shared/chunk-WPZ7VNTV.js";
import {
  closeBrackets,
  closeBracketsKeymap,
  init_dist as init_dist6
} from "/myst_assets_folder/_shared/chunk-J4YTOHIO.js";
import {
  Annotation,
  ChangeDesc,
  ChangeSet,
  ...
  tags,
  tooltips
} from "/myst_assets_folder/_shared/chunk-ARE3FLKF.js";
import {
  InputGroup,
  ObservableMap,
  ReactWidget,
...
var import_coreutils, RULERS_CLASSNAME, baseTheme, rulerConfig, plugin;
  ...
  "../../node_modules/@jupyterlab/codemirror/lib/extensions/rulers.js"() {
    ...
    plugin = ViewPlugin.fromClass(class {
      ...
      update(update) {
        ...
        if (update.viewportChanged || update.geometryChanged || !import_coreutils.JSONExt.deepEqual(widths, update.startState.facet(rulerConfig))) {
...
var init_environment = __esm({
  "../../node_modules/lib0/environment.js"() {
    ...
    getVariable = (name) => isNode ? undefinedToNull(process.env[name.toUpperCase()]) : undefinedToNull(varStorage.getItem(name));
...
var import_coreutils2, READ_ONLY_CLASS, ExtensionsHandler, EditorExtensionRegistry;
  ...
  "../../node_modules/@jupyterlab/codemirror/lib/extension.js"() {
    ...
    EditorExtensionRegistry = class {
      ...
      set baseConfiguration(v) {
        if (!import_coreutils2.JSONExt.deepEqual(v, this._baseConfiguration)) {
       ...
       */
      get settingsSchema() {
        return Object.freeze(import_coreutils2.JSONExt.deepCopy(this.configurationSchema));
      }
      /**
...
var import_coreutils3, YDocument;
var init_ydocument = __esm({
  "../../node_modules/@jupyter/ydoc/lib/ydocument.js"() {
    ...
    YDocument = class {
       ...
       */
      get state() {
        return import_coreutils3.JSONExt.deepCopy(this.ystate.toJSON());
      }
      /**
      ...
      getState(key) {
        ...
        return typeof value === "undefined" ? value : import_coreutils3.JSONExt.deepCopy(value);
      }
      /**
       ...
       */
      setState(key, value) {
        if (!import_coreutils3.JSONExt.deepEqual(this.ystate.get(key), value)) {
...
var init_ycell = __esm({
  "../../node_modules/@jupyter/ydoc/lib/ycell.js"() {
    import_coreutils4 = __toESM(require_dist(), 1);
    init_index_es6();
    init_awareness2();
  }
});
...
var init_ynotebook = __esm({
  "../../node_modules/@jupyter/ydoc/lib/ynotebook.js"() {
    import_coreutils5 = __toESM(require_dist(), 1);
    init_index_es6();
    init_ydocument();
    init_ycell();
  }
...
function LineColComponent(props) {
  ...
  return import_react.default.createElement(TextItem, { onClick: props.handleClick, source: trans.__("Ln %1, Col %2", props.line, props.column), title: trans.__("Go to line number\u2026") });
}
        ...
        return import_react.default.createElement(
          ...
          import_react.default.createElement(
            ...
            import_react.default.createElement(
              ...
              import_react.default.createElement("input", { type: "text", className: "jp-lineFormInput", onChange: this._handleChange, onFocus: this._handleFocus, onBlur: this._handleBlur, value: this.state.value, ref: (input) => {
            ...
            import_react.default.createElement("label", { className: "jp-lineFormCaption" }, this._trans.__("Go to line number between 1 and %1", this.props.maxLine))
          )
        );
      }
    };
...
var import_coreutils7, IEditorServices, IPositionModel;
...
var init_widget = __esm({
  "../../node_modules/@jupyterlab/codeeditor/lib/widget.js"() {
    ...
    (function(Private3) {
      ...
      Private3.findTextData = findTextData;
    })(Private || (Private = {}));
  }
});
...
var import_coreutils8, EditorLanguageRegistry;
var init_language = __esm({
  "../../node_modules/@jupyterlab/codemirror/lib/language.js"() {
    init_dist5();
    init_lib6();
    import_coreutils8 = __toESM(require_lib());
    init_lib();
    init_dist9();
    init_dist4();
    init_theme();
    EditorLanguageRegistry = class {
       ...
       */
      findByFileName(name) {
        const basename = import_coreutils8.PathExt.basename(name);
        for (let i = 0; i < this._modeList.length; i++) {
          let info = this._modeList[i];
    ...
    (function(EditorLanguageRegistry2) {
      ...
      async function sql(dialectName) {
        const m = await import("/myst_assets_folder/_shared/dist-TPXAYFXX.js");
        ...
        return [
          {
            ...
            extensions: ["c", "h", "ino"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/dist-PJHPJHOW.js");
              return m.cpp();
            }
          },
          {
          ...
          },
          {
            ...
            extensions: ["css"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/dist-CPKR7LPD.js");
              return m.css();
            }
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/dist-LLIA6MUH.js");
              return m.html();
            }
          },
          {
            ...
            extensions: ["java"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/dist-OCEHOJQP.js");
              return m.java();
            }
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/dist-CYF3O64F.js");
              return m.javascript();
            }
          },
          {
            ...
            extensions: ["json", "map"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/dist-LSP5AJVN.js");
              return m.json();
            }
          },
          {
          ...
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/dist-BRMS5CYE.js");
          ...
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/dist-JBP6A5DQ.js");
              return m.php();
            }
          },
          {
          ...
          },
          {
            ...
            filename: /^(BUCK|BUILD)$/,
            async load() {
              const m = await import("/myst_assets_folder/_shared/dist-56GHUESI.js");
              return m.python();
            }
          },
          {
          ...
          },
          {
            ...
            extensions: ["rs"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/dist-UWQSSNIO.js");
              return m.rust();
            }
          },
          {
          ...
          },
          {
            ...
            extensions: ["wat", "wast"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/dist-WMXO4JHF.js");
              return m.wast();
            }
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/dist-EUCBMSP2.js");
              return m.xml();
            }
          },
          // Legacy modes ported from CodeMirror 5
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/apl-WBYPGPVD.js");
              return legacy(m.apl);
            }
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/asciiarmor-3DCND37C.js");
          ...
          },
          {
            ...
            extensions: ["asn", "asn1"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/asn1-YNIWVKRN.js");
          ...
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/asterisk-POBB66WN.js");
          ...
          },
          {
            ...
            extensions: ["b", "bf"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/brainfuck-NCJBT5QB.js");
          ...
          },
          {
            ...
            extensions: ["cob", "cpy"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/cobol-GZTWTD4V.js");
          ...
          },
          {
            ...
            extensions: ["cs"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/clike-AYJO25IC.js");
          ...
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/clojure-N6ZC35RP.js");
          ...
          },
          {
            ...
            extensions: ["gss"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/css-KO5K3Q53.js");
              return legacy(m.gss);
            }
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/cmake-VMG6IQOI.js");
          ...
          },
          {
            ...
            extensions: ["coffee"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/coffeescript-IFGME57U.js");
          ...
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/commonlisp-ZIAKCXDG.js");
          ...
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/cypher-YYIIRJHH.js");
          ...
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/python-UEH4IQQW.js");
          ...
          },
          {
            ...
            extensions: ["cr"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/crystal-RNHINDJJ.js");
          ...
          },
          {
            ...
            extensions: ["d"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/d-73L2SFXV.js");
              return legacy(m.d);
            }
          },
          {
          ...
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/diff-YQAEZSWI.js");
          ...
          },
          {
            ...
            filename: /^Dockerfile$/,
            async load() {
              const m = await import("/myst_assets_folder/_shared/dockerfile-JPMXVDAL.js");
          ...
          },
          {
            ...
            extensions: ["dtd"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/dtd-MSLOAK3Y.js");
              return legacy(m.dtd);
            }
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/dylan-CDBDNXAL.js");
          ...
          },
          {
            ...
            mime: "text/x-ebnf",
            async load() {
              const m = await import("/myst_assets_folder/_shared/ebnf-FPQB6FE7.js");
          ...
          },
          {
            ...
            extensions: ["ecl"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/ecl-M2QEBLGT.js");
              return legacy(m.ecl);
            }
          },
          {
          ...
          },
          {
            ...
            extensions: ["e"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/eiffel-AUO7HHIC.js");
          ...
          },
          {
            ...
            extensions: ["elm"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/elm-3HJENXMC.js");
              return legacy(m.elm);
            }
          },
          {
            ...
            extensions: ["erl"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/erlang-JSRF6JYK.js");
          ...
          },
          {
            ...
            mime: "text/x-esper",
            async load() {
              const m = await import("/myst_assets_folder/_shared/sql-QPHQCVFA.js");
          ...
          },
          {
            ...
            extensions: ["factor"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/factor-3UTIVP4P.js");
          ...
          },
          {
            ...
            mime: "text/x-fcl",
            async load() {
              const m = await import("/myst_assets_folder/_shared/fcl-GXNX4JR6.js");
              return legacy(m.fcl);
            }
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/forth-YVVZ3X45.js");
          ...
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/fortran-EDTZXSGM.js");
          ...
          },
          {
            ...
            extensions: ["fs"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/mllike-FCDZF2CX.js");
          ...
          },
          {
            ...
            extensions: ["s"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/gas-7CBF34MA.js");
              return legacy(m.gas);
            }
          },
          {
            ...
            extensions: ["feature"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/gherkin-GY4E7RLV.js");
          ...
          },
          {
            ...
            extensions: ["go"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/go-JU5VGE6A.js");
              return legacy(m.go);
            }
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/groovy-O4CXVS46.js");
          ...
          },
          {
            ...
            extensions: ["hs"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/haskell-P4YTJ65P.js");
          ...
          },
          {
            ...
            extensions: ["hx"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/haxe-NCCG5XVB.js");
          ...
          },
          {
            ...
            mime: "message/http",
            async load() {
              const m = await import("/myst_assets_folder/_shared/http-ZXW7GCXS.js");
          ...
          },
          {
            ...
            extensions: ["pro"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/idl-T6NGYFGH.js");
              return legacy(m.idl);
            }
          },
          {
            ...
            extensions: ["jsonld"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/javascript-A2CGBD5B.js");
          ...
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/jinja2-GXNNEWSP.js");
          ...
          },
          {
            ...
            extensions: ["jl"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/julia-VRNLDHTO.js");
          ...
          },
          {
            ...
            extensions: ["ls"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/livescript-EBZUU6JI.js");
          ...
          },
          {
            ...
            extensions: ["lua"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/lua-FPZMEF6U.js");
              return legacy(m.lua);
            }
          },
          {
            ...
            mime: "text/mirc",
            async load() {
              const m = await import("/myst_assets_folder/_shared/mirc-I6ZWOFH6.js");
          ...
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/mathematica-CGLKKP3P.js");
          ...
          },
          {
            ...
            extensions: ["mo"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/modelica-VNDRJ6HK.js");
          ...
          },
          {
            ...
            extensions: ["mps"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/mumps-RLI2TCAX.js");
          ...
          },
          {
            ...
            extensions: ["mbox"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/mbox-X3DFKMTH.js");
          ...
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/nginx-SMDVL3TB.js");
          ...
          },
          {
            ...
            extensions: ["nsh", "nsi"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/nsis-DK5IZOVW.js");
          ...
          },
          {
            ...
            extensions: ["nt", "nq"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/ntriples-XF7RFRPI.js");
          ...
          },
          {
            ...
            extensions: ["m"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/octave-VLOUOFVN.js");
          ...
          },
          {
            ...
            extensions: ["oz"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/oz-5BJV7BA6.js");
              return legacy(m.oz);
            }
          },
          {
            ...
            extensions: ["p", "pas"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/pascal-6SBW4D45.js");
          ...
          },
          {
            ...
            extensions: ["pl", "pm"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/perl-DTFOIDIO.js");
          ...
          },
          {
            ...
            extensions: ["pig"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/pig-OUOKJK3U.js");
              return legacy(m.pig);
            }
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/powershell-WDKBLNKM.js");
          ...
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/properties-DD6YWWCU.js");
          ...
          },
          {
            ...
            extensions: ["proto"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/protobuf-U2UI3HA6.js");
          ...
          },
          {
            ...
            extensions: ["pp"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/puppet-QCUVA2SY.js");
          ...
          },
          {
            ...
            extensions: ["q"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/q-QGKEQGLA.js");
              return legacy(m.q);
            }
          },
          {
            ...
            extensions: ["r", "R"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/r-SKE6FHXS.js");
              return legacy(m.r);
            }
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/rpm-XEYNL3UD.js");
          ...
          },
          {
            ...
            extensions: ["rb"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/ruby-NPNG7W2B.js");
          ...
          },
          {
            ...
            extensions: ["sas"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/sas-QHJ3EZMO.js");
              return legacy(m.sas);
            }
          },
          {
          ...
          },
          {
            ...
            extensions: ["scm", "ss"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/scheme-ZPOXDTA2.js");
          ...
          },
          {
            ...
            filename: /^PKGBUILD$/,
            async load() {
              const m = await import("/myst_assets_folder/_shared/shell-QM5LL43K.js");
          ...
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/sieve-JZEYFJYX.js");
          ...
          },
          {
            ...
            extensions: ["st"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/smalltalk-SHPX453J.js");
          ...
          },
          {
            ...
            mime: "text/x-solr",
            async load() {
              const m = await import("/myst_assets_folder/_shared/solr-FWMRYSZV.js");
          ...
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/sparql-ZE3JW3BU.js");
          ...
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/spreadsheet-FONJT3NI.js");
          ...
          },
          {
            ...
            extensions: ["styl"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/stylus-J75HC22Q.js");
          ...
          },
          {
            ...
            extensions: ["swift"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/swift-YENO57XQ.js");
          ...
          },
          {
            ...
            mime: "text/x-stex",
            async load() {
              const m = await import("/myst_assets_folder/_shared/stex-J77W2EAB.js");
          ...
          },
          {
            ...
            extensions: ["v", "sv", "svh"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/verilog-5H67HMKX.js");
          ...
          },
          {
            ...
            extensions: ["tcl"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/tcl-PIDPQOP3.js");
              return legacy(m.tcl);
            }
          },
          {
            ...
            extensions: ["textile"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/textile-LVAXVLE6.js");
          ...
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/tiddlywiki-P4TQTDYT.js");
          ...
          },
          {
            ...
            mime: "text/tiki",
            async load() {
              const m = await import("/myst_assets_folder/_shared/tiki-AJAYAFUL.js");
          ...
          },
          {
            ...
            extensions: ["toml"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/toml-6YVQWW5X.js");
          ...
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/troff-733ZBC2V.js");
          ...
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/ttcn-XWHRNK7V.js");
          ...
          },
          {
            ...
            extensions: ["cfg"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/ttcn-cfg-F62LRWEB.js");
          ...
          },
          {
            ...
            extensions: ["ttl"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/turtle-4Z3VCE2Y.js");
          ...
          },
          {
            ...
            extensions: ["webidl"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/webidl-C256MF76.js");
          ...
          },
          {
            ...
            extensions: ["vb"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/vb-GRBDYVAW.js");
              return legacy(m.vb);
            }
          },
          {
            ...
            extensions: ["vbs"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/vbscript-NGX7GLKL.js");
          ...
          },
          {
            ...
            extensions: ["vtl"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/velocity-SBY45XQJ.js");
          ...
          },
          {
            ...
            extensions: ["vhd", "vhdl"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/vhdl-B7TELP2Z.js");
          ...
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/xquery-4B2IOVF5.js");
          ...
          },
          {
            ...
            extensions: ["ys"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/yacas-XQKX37TJ.js");
          ...
          },
          {
            ...
            extensions: ["yaml", "yml"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/yaml-FPY7E6GI.js");
          ...
          },
          {
            ...
            extensions: ["z80"],
            async load() {
              const m = await import("/myst_assets_folder/_shared/z80-EIH3IGRD.js");
              return legacy(m.z80);
            }
          },
          {
            ...
            async load() {
              const m = await import("/myst_assets_folder/_shared/mscgen-J4EKIDTY.js");
...
var import_coreutils9, Private2;
var init_editor2 = __esm({
  "../../node_modules/@jupyterlab/codemirror/lib/editor.js"() {
    ...
    (function(Private3) {
      ...
      Private3.createEditor = createEditor;
    })(Private2 || (Private2 = {}));
  }
});
...
var init_searchprovider = __esm({
  "../../node_modules/@jupyterlab/codemirror/lib/searchprovider.js"() {
    ...
    (function(Utils2) {
      ...
      Utils2.findNext = findNext;
    })(Utils || (Utils = {}));
  }
});

// ../../node_modules/@jupyterlab/codemirror/lib/token.js
var import_coreutils10, IEditorExtensionRegistry, IEditorLanguageRegistry, IEditorThemeRegistry;
var init_token = __esm({
  "../../node_modules/@jupyterlab/codemirror/lib/token.js"() {
    import_coreutils10 = __toESM(require_dist());
    IEditorExtensionRegistry = new import_coreutils10.Token("@jupyterlab/codemirror:IEditorExtensionRegistry", `A registry for CodeMirror extension factories.`);
    IEditorLanguageRegistry = new import_coreutils10.Token("@jupyterlab/codemirror:IEditorLanguageRegistry", "A registry for CodeMirror languages.");
    IEditorThemeRegistry = new import_coreutils10.Token("@jupyterlab/codemirror:IEditorThemeRegistry", "A registry for CodeMirror theme.");
  }
});
...
function filterPaths(data, query, parent = ["root"]) {
  if (import_coreutils11.JSONExt.isArray(data)) {
  ...
  if (import_coreutils11.JSONExt.isObject(data)) {
...
var import_coreutils11, React11, import_react_highlight_words, Component2, theme;
    ...
    Component2 = class extends React11.Component {
      ...
      render() {
        ...
        return React11.createElement(
          ...
          React11.createElement(InputGroup, { className: "filter", type: "text", placeholder: trans.__("Filter\u2026"), onChange: this.handleChange, value: this.state.value, rightIcon: "ui-components:search" }),
...
react-highlight-words/dist/main.js:
  ...
  *)
*/
//# sourceMappingURL=/myst_assets_folder/_shared/component-WSYCTQ3T.js.map
