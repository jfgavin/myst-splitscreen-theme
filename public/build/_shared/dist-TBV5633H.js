import {
  ...
  require_uc,
  u
} from "/myst_assets_folder/_shared/chunk-3WPAJQ6A.js";
import {
  require_entities
...
function computeBlockTightness(src, map3) {
  const lines = src.split("\n");
  const tightBefore = typeof (map3 === null || map3 === void 0 ? void 0 : map3[0]) === "number" && map3[0] > 0 ? lines[map3[0] - 1].trim() !== "" : false;
  const tightAfter = typeof (map3 === null || map3 === void 0 ? void 0 : map3[1]) === "number" && map3[1] < lines.length ? lines[map3[1]].trim() !== "" : false;
...
function parseTags(input, vfile, node) {
  ...
  if (typeof input === "string" && input.startsWith("[") && input.endsWith("]")) {
    try {
      return parseTags(js_yaml_default2.load(input), vfile, node);
    } catch (error) {
  ...
  if (typeof input === "string") {
    const tags2 = input.split(/[,\s]/).map((t2) => t2.trim()).filter((t2) => !!t2);
...
// ../../node_modules/myst-directives/node_modules/csv-parse/dist/esm/sync.js
...
Buffer.prototype.inspect = function inspect() {
  ...
  if (this.length > 0) {
    str3 = this.toString("hex", 0, max).match(/.{2}/g).join(" ");
    if (this.length > max)
      str3 += " ... ";
  }
  return "<Buffer " + str3 + ">";
...
function base64ToBytes(str3) {
  return toByteArray(base64clean(str3));
}
...
var normalize_columns_array = function(columns) {
  ...
  for (let i2 = 0, l2 = columns.length; i2 < l2; i2++) {
  ...
  return {
    ...
    __onRecord: function(push) {
      ...
      if (from2 === 1 || this.info.records >= from2) {
        ...
        if (columns !== false) {
          const obj = {};
          for (let i2 = 0, l2 = record.length; i2 < l2; i2++) {
  ...
  run(data, vfile, ctx) {
    ...
    try {
      ...
      fileError(vfile, "csv-table directive body must be valid CSV-formatted MyST", {
        node: (_d = select("mystDirectiveBody", data.node)) !== null && _d !== void 0 ? _d : data.node,
        ruleId: RuleId.directiveBodyCorrect
      });
    }
...
function getTokenHandlers(specHandlers) {
  ...
  Object.entries(specHandlers).forEach(([type3, spec]) => {
    ...
    if (noCloseToken(spec, type3)) {
      ...
      handlers[type3 + "_open"] = (state, tok, tokens, i2) => state.openNode(nodeType, tok, getAttrs(state, spec, tok, tokens, i2));
...
// ../../node_modules/myst-parser/dist/tokensToMyst.js
function computeAmsmathTightness(src, map3) {
  var _a;
  const lines = src.split("\n");
  const tightBefore = typeof (map3 === null || map3 === void 0 ? void 0 : map3[0]) === "number" && map3[0] > 0 ? lines[map3[0] - 1].trim() !== "" : false;
  const last = typeof (map3 === null || map3 === void 0 ? void 0 : map3[1]) === "number" ? (map3 === null || map3 === void 0 ? void 0 : map3[1]) + 1 : void 0;
...
var defaultMdast = {
  ...
  amsmath: {
    ...
    noCloseToken: true,
    isText: true,
    getAttrs(t2, tokens, index, state) {
      var _a;
...
js-yaml/dist/js-yaml.mjs:
  (*! js-yaml 4.1.0 https://github.com/nodeca/js-yaml @license MIT *)
*/
//# sourceMappingURL=/myst_assets_folder/_shared/dist-TBV5633H.js.map
